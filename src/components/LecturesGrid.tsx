      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
        {lectures.map((video) => (
          <div 
            ...
            className="group cursor-pointer bg-zinc-900/30 hover:bg-zinc-900/60 border border-white/5 hover:border-white/15 rounded-2xl overflow-hidden transition-all duration-300 transform hover:-translate-y-1 shadow-lg flex flex-col h-full"
          >
            {/* Live True Thumbnail Asset */}
            <div className="relative aspect-video w-full bg-zinc-950 overflow-hidden border-b border-white/5 shrink-0">
              <img 
                src={video.thumbnail} 
                alt={video.title} 
              ...
              <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center shadow-lg transition-transform duration-300 transform scale-90 group-hover:scale-100">
